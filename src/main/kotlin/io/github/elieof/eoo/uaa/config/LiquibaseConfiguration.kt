    ...
    fun liquibase(
        ...
        dataSourceProperties: DataSourceProperties
            ...
            SpringLiquibaseUtil.createAsyncSpringLiquibase(
                liquibaseDataSource.ifAvailable, liquibaseProperties, dataSource.ifUnique, dataSourceProperties,
                this.env, executor)
            .apply {
            ...
            if (env.acceptsProfiles(Profiles.of(EooProfiles.SPRING_PROFILE_NO_LIQUIBASE))) {
                setShouldRun(false)
            } else {
