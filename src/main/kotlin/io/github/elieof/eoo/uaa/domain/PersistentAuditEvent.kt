package io.github.elieof.eoo.uaa.domain
 ...
 */
@Entity
@Table(name = "eoo_persistent_audit_event")
data class PersistentAuditEvent(
    ...
    @Column(name = "value")
    @CollectionTable(name = "eoo_persistent_audit_evt_data", joinColumns = [JoinColumn(name = "event_id")])
